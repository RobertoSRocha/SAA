        ...
        <div class="col-sm-6 text-left">				
            <ol class="breadcrumb">
                ...
                <li><i class="ion ion-android-document"></i>
                    <small> Requerimento de Afastamento Para Participação em Evento Científico</small>
                </li>
            </ol>		
        </div>			
                    ...
                    <form action=add.php method="post">
                        ...
                        <div class="form-group">	      
                            ...
                            <input type="text" class="form-control" id="evento" 
                                      ...
                                      name="formResidencia02['evento']" required="">	    
                        </div>
                        <div class="form-group">
                                <label class="title">
